  ...
  return (
    <div className="bg-secondary py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto text-center mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          {stats.map((stat, index) => (
            <div
              key={stat.label}
              className="animate-fade-in bg-secondary/80 backdrop-blur-sm border border-primary/20 p-6 rounded-lg"
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold text-white mb-6">Led by 3 General Partners</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((partner) => (
              <div 
                key={partner}
                className="bg-secondary/60 backdrop-blur-sm border border-primary/10 p-6 rounded-lg"
              >
                <div className="w-24 h-24 bg-secondary/80 rounded-full mx-auto mb-4 overflow-hidden">
